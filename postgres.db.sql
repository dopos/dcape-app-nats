/*
 File source: https://raw.githubusercontent.com/nats-io/nats-streaming-server/master/scripts/postgres.db.sql
*/
...
GRANT INSERT,SELECT,UPDATE ON ALL TABLES IN SCHEMA public TO :PGUSER;
